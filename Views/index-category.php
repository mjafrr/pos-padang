                      ...
                      <table class="table table-striped">
                        ...
                        <tr >
                          ...
                          <td class="justify-content-end">
                            ...
                            <a href="../services/delete-category.php?id=<?= $category['id_category']?>" class="btn btn-danger mr-1" onclick="return confirm('Are you sure want to delete this?')"><i class="far fa-trash-alt"></i> Hapus</a>
                          </td>
                        </tr>
                        <?php endforeach ?>
                      </table>
